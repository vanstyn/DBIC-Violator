package DBIC::Violator::LogExplore;
use Moose;
...
__PACKAGE__->config(
    ...
    'Plugin::RapidApp::TabGui' => {
      title => "DBIC::Violator::LogExplore v$VERSION",
    ...
    'Controller::RapidApp::Template' => {
      ...
      #access_class => 'DBIC::Violator::LogExplore::Template::Access',
...
#  rapidapp.pl --helpers RapidDbic,Templates,TabGui,AuthCore,NavCore DBIC::Violator::LogExplore -- --dsn dbi:SQLite:/opt/dbic-violator-log_000001.db
# ---
...
DBIC::Violator::LogExplore - Catalyst/RapidApp based application

=head1 SYNOPSIS

    script/dbic_violator_logexplore_server.pl
